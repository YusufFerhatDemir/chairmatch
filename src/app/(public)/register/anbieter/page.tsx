            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  {CATEGORIES.map(c => (
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${f.kat === c ? 'var(--gold)' : 'rgba(176,120,8,0.12)'}`,
                      }}
                    >
                      {c}
                    </button>
              ...
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${f.gb ? 'var(--gold)' : 'rgba(176,120,8,0.1)'}`,
                }}
              >
                <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: f.chair ? 'rgba(176,120,8,0.06)' : 'var(--c2)', borderRadius: 12, cursor: 'pointer',
                  border: `1.5px solid ${f.chair ? 'var(--gold)' : 'rgba(176,120,8,0.1)'}`,
                }}
              >
                <div style={{
                  width: 20, height: 20, borderRadius: 5, display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <div>
              ...
              <div className="card" style={{ padding: 14, marginBottom: 16 }}>
                {([['Name', `${f.vn} ${f.nn}`], ['E-Mail', f.em], ['Geschäft', f.geschaeft], ['Stadt', f.city], ['Kategorie', f.kat], ['Stuhlmiete', f.chair ? `${f.cpr}€/Tag` : 'Nein']] as const).map(([k, v]) => (
                  <div key={k} style={{ display: 'flex', justifyContent: 'space-between', padding: '7px 0', borderBottom: '1px solid rgba(176,120,8,0.06)', fontSize: 13 }}>
              ...
              {(['agb', 'dsgvo'] as const).map(key => (
                <div key={key} onClick={() => upd(key, !f[key])} style={{ display: 'flex', gap: 10, padding: '12px 0', borderBottom: '1px solid rgba(176,120,8,0.06)', cursor: 'pointer', alignItems: 'center' }}>
                  <div style={{
                    width: 20, height: 20, borderRadius: 5, display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: 10, flexShrink: 0,
