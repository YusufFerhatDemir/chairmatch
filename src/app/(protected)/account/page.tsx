      ...
      <div className="screen" style={{ padding: '20px var(--pad) 0' }}>
        ...
        {role === 'kunde' && (
          <Link href="/register/anbieter" style={{ textDecoration: 'none' }}>
            <div className="card" style={{ padding: 0, marginBottom: 14, background: 'linear-gradient(135deg, #1A1608, #100E04)', border: '1px solid rgba(190,133,16,0.2)', overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ flexShrink: 0, width: 100, height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #0A0600, #180C04)', borderRight: '1px solid rgba(190,133,16,0.12)' }}>
        ...
        <div style={{ marginTop: 22, paddingTop: 16, borderTop: '1px solid rgba(190,133,16,0.08)' }}>
          <p style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.12em', color: 'var(--stone)', textTransform: 'uppercase', marginBottom: 10 }}>
            Meine Daten
          </p>
          <button
        ...
        {/* Rechtliches */}
        <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid rgba(190,133,16,0.08)' }}>
          <p style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.12em', color: 'var(--stone)', textTransform: 'uppercase', marginBottom: 10 }}>
            Rechtliches
          </p>
          {([
            ...
            <Link key={href} href={href} style={{ textDecoration: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid rgba(190,133,16,0.06)' }}>
          ...
          <button
            ...
            className="boutline"
            style={{ marginTop: 8, borderColor: 'rgba(190,133,16,0.3)', width: '100%' }}
          >
            Abmelden
          </button>
